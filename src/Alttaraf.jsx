        ...
        <div className='altrow' id='celikgrubu'>
          ...
          <div className='altimage'>
            ...
            <div style={{ overflow: "hidden" }} className='imagedetail' data-aos="fade-left" data-aos-duration="2000">
              demir malzemelerin kullanıldığı çatı işleri ve konstrüksiyon işlerine odaklanan bir projeyi ifade eder.
              şirketimiz  demir profilleri, çubukları ve plakaları kullanarak çatıların inşası ve onarımı gibi hizmetler sunar.
              Demir çatılar genellikle dayanıklılık ve mukavemet için tercih edilir.
              İlgili bir demir çatı grubu hakkında daha fazla bilgi edinmek için bizimle iletişime geçebilirsiniz
